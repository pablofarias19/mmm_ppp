 ...
 *
 * Límites: máx 3 fotos de galería · máx 300 KB por foto · JPG / PNG / WebP
...
if ($method === 'POST') {
    ...
    if ($action === 'upload') {
        ...
        if ($file['size'] > $maxSize) {
            echo json_encode(['success' => false, 'message' => 'La imagen no puede superar 300 KB. Comprimila en squoosh.app o tinypng.com antes de subir.']);
            exit;
        }
