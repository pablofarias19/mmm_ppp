...
$defaultIcons = [
    ...
    'medico_pediatra' => ['emoji' => '🧒', 'color' => '#0ea5e9'],
    'medico_traumatologo' => ['emoji' => '🦴', 'color' => '#2563eb'],
    'laboratorio'    => ['emoji' => '🧪',  'color' => '#14b8a6'],
    ...
    'enfermeria'     => ['emoji' => '🩺',  'color' => '#0ea5e9'],
    'asistencia_ancianos' => ['emoji' => '🧓', 'color' => '#14b8a6'],
    // Belleza & Bienestar
    ...
    'ingenieria_civil' => ['emoji' => '🏗️', 'color' => '#f59e0b'],
    'electricista'   => ['emoji' => '💡',  'color' => '#facc15'],
    'gasista'        => ['emoji' => '🔥',  'color' => '#f97316'],
    'gas_en_garrafa' => ['emoji' => '🛢️', 'color' => '#0ea5e9'],
    'seguridad'      => ['emoji' => '🛡️', 'color' => '#334155'],
    'grafica'        => ['emoji' => '🖨️', 'color' => '#a855f7'],
    'astrologo'      => ['emoji' => '🔮',  'color' => '#6366f1'],
    'zapatero'       => ['emoji' => '👞',  'color' => '#7c2d12'],
    'videojuegos'    => ['emoji' => '🎮',  'color' => '#8b5cf6'],
    'maestro_particular' => ['emoji' => '📘', 'color' => '#0ea5e9'],
    'alquiler_mobiliario_fiestas' => ['emoji' => '🪑', 'color' => '#f59e0b'],
    'propalacion_musica' => ['emoji' => '🔊', 'color' => '#6366f1'],
    'animacion_fiestas' => ['emoji' => '🎉', 'color' => '#ec4899'],
