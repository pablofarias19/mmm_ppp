...
-- Tiempo de generación: 20-04-2026 a las 21:42:38
...
INSERT INTO `businesses` (`id`, `user_id`, `name`, `address`, `lat`, `lng`, `phone`, `email`, `website`, `instagram`, `facebook`, `tiktok`, `certifications`, `has_delivery`, `has_card_payment`, `is_franchise`, `verified`, `business_type`, `visible`, `status`, `created_at`, `updated_at`, `price_range`, `description`, `subcategory_id`, `company_size`, `location_city`, `style`, `mapita_id`, `oferta_activa_id`, `og_image_url`) VALUES
(9142, 1, 'Panadería Central', 'Av. Corrientes 1234, CABA', -34.603700, -58.381600, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'comercio', 1, 'active', '2026-04-16 07:07:40', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9143, 1, 'Hotel Plaza Mayor', 'San Martín 456, CABA', -34.601000, -58.373000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'hotel', 1, 'active', '2026-04-16 07:07:40', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9144, 1, 'Restaurante La Típica', 'Humberto 1° 789, CABA', -34.608000, -58.385000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'restaurante', 1, 'active', '2026-04-16 07:07:40', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9145, 1, 'Farmacia Salud Plus', 'Belgrano 321, CABA', -34.595000, -58.390000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'farmacia', 1, 'active', '2026-04-16 07:07:40', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9146, 1, 'Gimnasio FitLife', 'Lavalle 654, CABA', -34.602000, -58.376000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'gimnasio', 1, 'active', '2026-04-16 07:07:40', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9147, 5, 'pasito de los toros', 'BARRIO LULUS FRIEND', -32.806335, -56.519024, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'comercio', 1, 'active', '2026-04-17 01:20:32', NULL, 3, 'Es un fabrica que vende pasito de los toros.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9148, 5, 'PASITO DE LOS TOROS', 'Baltasar Brum', -32.814667, -56.514715, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'comercio', 1, 'active', '2026-04-17 01:22:37', NULL, 3, 'XD', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9149, 6, 'Nico', 'Julio Verne 616', -34.616882, -58.369492, '+541168480793', 'estudio@fariasortiz.com.ar', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 'panaderia', 1, 'active', '2026-04-20 06:15:41', '2026-04-20 16:03:08', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '/uploads/businesses/9149/og_cover.jpg');
...
(1, 'comercio', '🛍️', 'icon-comercio', '#e74c3c', '2026-04-19 07:17:15'),
(2, 'hotel', '🏨', 'icon-hotel', '#3498db', '2026-04-19 07:17:15'),
(3, 'restaurante', '🍽️', 'icon-restaurante', '#e67e22', '2026-04-19 07:17:15'),
(4, 'inmobiliaria', '🏠', 'icon-inmobiliaria', '#27ae60', '2026-04-19 07:17:15'),
(5, 'farmacia', '💊', 'icon-farmacia', '#9b59b6', '2026-04-19 07:17:15'),
(6, 'gimnasio', '💪', 'icon-gimnasio', '#1abc9c', '2026-04-19 07:17:15'),
(7, 'cafeteria', '☕', 'icon-cafeteria', '#d35400', '2026-04-19 07:17:15'),
(8, 'academia', '📚', 'icon-academia', '#2980b9', '2026-04-19 07:17:15'),
(9, 'bar', '🍺', 'icon-bar', '#8e44ad', '2026-04-19 07:17:15'),
(10, 'salon_belleza', '💇', 'icon-salon', '#e91e63', '2026-04-19 07:17:15'),
(11, 'banco', '🏦', 'icon-banco', '#16a085', '2026-04-19 07:17:15'),
(12, 'tienda_ropa', '👕', 'icon-ropa', '#c0392b', '2026-04-19 07:17:15'),
(13, 'supermercado', '🛒', 'icon-super', '#8e44ad', '2026-04-19 07:17:15'),
(14, 'cine', '🎬', 'icon-cine', '#2980b9', '2026-04-19 07:17:15'),
(15, 'biblioteca', '📖', 'icon-biblioteca', '#27ae60', '2026-04-19 07:17:15'),
(16, 'parque', '🌳', 'icon-parque', '#16a085', '2026-04-19 07:17:15'),
(17, 'hospital', '🏥', 'icon-hospital', '#e74c3c', '2026-04-19 07:17:15'),
(18, 'escuela', '🎓', 'icon-escuela', '#3498db', '2026-04-19 07:17:15'),
(19, 'estacion', '🚂', 'icon-estacion', '#34495e', '2026-04-19 07:17:15'),
(20, 'gasolinera', '⛽', 'icon-gasolina', '#f39c12', '2026-04-19 07:17:15'),
(21, 'estacionamiento', '🅿️', 'icon-parking', '#95a5a6', '2026-04-19 07:17:15'),
(22, 'taxi', '🚕', 'icon-taxi', '#f1c40f', '2026-04-19 07:17:15'),
(23, 'carne', '🥩', 'icon-carne', '#e74c3c', '2026-04-19 07:17:15'),
(24, 'pescaderia', '🐟', 'icon-pescado', '#3498db', '2026-04-19 07:17:15'),
(25, 'panaderia', '🥐', 'icon-pan', '#d35400', '2026-04-19 07:17:15'),
(26, 'pasteleria', '🎂', 'icon-pastel', '#e91e63', '2026-04-19 07:17:15'),
(27, 'heladeria', '🍦', 'icon-helado', '#3498db', '2026-04-19 07:17:15'),
(28, 'fruteria', '🍎', 'icon-frutas', '#27ae60', '2026-04-19 07:17:15'),
(29, 'verduleria', '🥬', 'icon-verduras', '#27ae60', '2026-04-19 07:17:15'),
(30, 'bebidas', '🥤', 'icon-bebidas', '#9b59b6', '2026-04-19 07:17:15'),
(31, 'otros', '📍', 'icon-otros', '#667eea', '2026-04-19 07:17:15');
...
(5, 'Pablo_Farias', '$2y$10$2/lTT0OjnVkUVMaJt6i4Yuw40uhT4v2focifLJUYnb9GDrRKTLb1S', 'pablofarias19@gmail.com', NULL, 0, NULL, NULL, 0, '2026-04-10 16:06:07', '2026-04-20 14:20:55', NULL, NULL),
...
(15, 'negocio', 9143, 5, 'Pablo_Farias', 'uid:5', '2026-04-19 23:40:55', '2026-04-19 23:40:55'),
(72, 'negocio', 9145, 5, 'Pablo_Farias', 'uid:5', '2026-04-20 19:37:49', '2026-04-20 19:37:49'),
(163, 'negocio', 9148, 5, 'Pablo_Farias', 'uid:5', '2026-04-20 01:11:11', '2026-04-20 01:11:11'),
(205, 'negocio', 9144, 5, 'Pablo_Farias', 'uid:5', '2026-04-20 20:35:42', '2026-04-20 20:35:42'),
...
(403, 'negocio', 9148, 6, 'Nicolas_FO', 'uid:6', '2026-04-20 21:42:33', '2026-04-20 21:42:33'),
(406, 'negocio', 9149, 6, 'Nicolas_FO', 'uid:6', '2026-04-20 21:42:33', '2026-04-20 21:42:33'),
(410, 'negocio', 9149, 5, 'Pablo_Farias', 'uid:5', '2026-04-20 21:06:17', '2026-04-20 21:06:17'),
